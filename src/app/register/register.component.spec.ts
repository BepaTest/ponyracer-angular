...
describe('RegisterComponent', () => {
  ...
  it('should display a form to register', () => {
    ...
    expect(passwordCtrl).withContext('Your password form should have a `password` field').not.toBeNull();
    ...
    expect(confirmPasswordCtrl).withContext('Your password form should have a `confirmPassword` field').not.toBeNull();
